...
export async function generateMetadata(
  ...
  // const { seo } = res || {};
  const seo: SEO = {
    title: "Create AI House | PawTime",
    description: "Create a new AI House listing",
    image: {
      id: "",
      alt: "Create AI House | PawTime",
      src: "",
    },
  };
  const { image } = seo || {};
  ...
  return {
    title,
    description,
    metadataBase: new URL(`${CONFIG.website.domain}/dashboard/create-ai-house`),
    openGraph: {
      title,
      description,
      url: "/",
