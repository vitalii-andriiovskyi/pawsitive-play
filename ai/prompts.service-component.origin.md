...
While creating the TypeScript interface to describe component’s properties, use the Image interface from the file #file:image.ts

For the image in UI, use component <Image /> like it is shown on the page #fetch
